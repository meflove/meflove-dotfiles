...
const keyboardLayout = oskLayouts[userOptions.onScreenKeyboard.layout]
  ? userOptions.onScreenKeyboard.layout
  : DEFAULT_OSK_LAYOUT;
                ...
                button.connect("clicked", () => {
                  ...
                  if (shiftMode == ShiftMode.Normal) {
                    ...
                    allButtons.forEach((button) => {
                      if (
                        typeof button.attribute.key.labelShift !== "undefined"
                      )
                ...
                button.connect("pressed", () => {
                  ...
                  if (pressed) {
                    ...
                    if (key.keycode == 100) {
                      ...
                      allButtons.forEach((button) => {
                        if (
                          typeof button.attribute.key.labelAlt !== "undefined"
                        )
                          button.label = button.attribute.key.label;
                      });
                    }
                    ...
                    if (!(key.keycode == 42 || key.keycode == 54))
                      ...
                      switch (
                        shiftMode.name // This toggles the shift button state
                      ) {
                        case "Off":
                          {
                            ...
                            allButtons.forEach((button) => {
                              if (
                                typeof button.attribute.key.labelShift !==
                                "undefined"
                              )
                                button.label = button.attribute.key.labelShift;
                            });
                            if (typeof shiftButton !== "undefined") {
                              shiftButton.toggleClassName(
                                "osk-key-active",
                                true,
                              );
                            }
                            if (typeof rightShiftButton !== "undefined") {
                              rightShiftButton.toggleClassName(
                                "osk-key-active",
                                true,
                              );
                            }
                        ...
                        case "Locked": {
                          ...
                          execAsync(`ydotool key ${key.keycode}:0`).catch(
                            print,
                          );
